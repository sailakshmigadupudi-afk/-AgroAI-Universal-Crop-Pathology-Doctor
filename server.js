...
const db = new sqlite3.Database('./agroai.db', (err) => {
    if (err) console.error("Database error:", err.message);
    else console.log("✅ SQLite AgroAI Database connected.");
});
...
app.listen(PORT, () => {
    console.log(`🚀 AgroAI Backend running on http://localhost:${PORT}`);
});
